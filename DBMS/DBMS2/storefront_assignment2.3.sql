...
#3.3. Display all the Orders which are placed more than 10 days old and one or more items from those orders are still not shipped.
SELECT o.orderId, o.order_placing_date, o.bill, op.orderStatus
FROM orders o, order_product op
WHERE o.orderId = op.orderId AND op.orderStatus = 'awaiting shipping'
;
