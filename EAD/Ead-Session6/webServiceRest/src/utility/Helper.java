...
/**
 * @author Priya Helper class is a helper utility for book
 */
public class Helper {

	/**
	 * @param book
	 * @return 1 if successfully inserted else return 0 Adds Book
	 */
	public static int addBook(Book book) {
		try {
			Connection c = Jdbc.makeConnection();
	...
	/**
	 * @return list of books Gets All books
	 */
	...
	/**
	 * @param title
	 * @return list of books Gets Books by title
	 */
	...
	/**
	 * @param book
	 * @return 1 or 0 accordingly Updates Book
	 */
	...
	/** 
	 * @param id
	 * @return 1 or 0 accordingly Deletes book by id
	 */
	public static int deleteBookById(int id) {
		try (Connection c = Jdbc.makeConnection(); PreparedStatement p = c.prepareStatement(Query.deleteById(id))) {
			return p.executeUpdate();
		} catch (SQLException exc) {
			exc.printStackTrace();
			return 0;
	...
	/**
	 * @return 1 or 0 accordingly Deletes all books
	 */
